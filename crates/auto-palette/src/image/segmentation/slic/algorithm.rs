    ...
    T: FloatNumber,
{
    ...
    #[must_use]
    pub fn builder() -> SlicSegmentationBuilder<T> {
        SlicSegmentationBuilder::default()
    }
...
/// * `T` - The floating point type.
#[derive(Debug, PartialEq)]
pub struct SlicSegmentationBuilder<T>
where
    T: FloatNumber,
{
    segments: usize,
...
impl<T> SlicSegmentationBuilder<T>
where
    T: FloatNumber,
{
    ...
    #[allow(dead_code)]
    #[must_use]
    pub fn generator(mut self, generator: SeedGenerator) -> SlicSegmentationBuilder<T> {
...
impl<T> Default for SlicSegmentationBuilder<T>
where
    T: FloatNumber,
{
    fn default() -> Self {
