    ...
    T: FloatNumber,
{
    ...
    #[must_use]
    pub fn builder() -> SnicSegmentationBuilder<T> {
        SnicSegmentationBuilder::default()
    }
...
/// Builder for the `SnicSegmentation` algorithm.
///
/// # Type Parameters
/// * `T` - The floating point type.
#[derive(Debug, PartialEq)]
pub struct SnicSegmentationBuilder<T>
where
    T: FloatNumber,
{
    segments: usize,
...
impl<T> SnicSegmentationBuilder<T>
where
    T: FloatNumber,
{
...
impl<T> Default for SnicSegmentationBuilder<T>
where
    T: FloatNumber,
{
    fn default() -> Self {
...
mod tests {
    ...
    fn test_builder() {
        ...
        // Assert
        assert_eq!(actual, SnicSegmentationBuilder::<f64>::default());
    }
