...
/// Struct for calculating the auto-palette distance of points in a dataset using HDBSCAN algorithm.
///
/// # Type Parameters
    ...
    F: Float,
{
    ...
    /// * `distance` - The distance metric to use for calculating auto-palette distances.
    ///
    /// # Returns
    ...
    /// Returns the auto-palette distance at the given index.
    ///
    /// # Arguments
    /// * `index` - The index of the point in the dataset.
    ///
    /// # Returns
    /// The auto-palette distance of the point at the given index.
    ///
    /// # Panics
