...
impl<'a> SimpleImageData<'a> {
    ...
    pub fn new(data: &'a [u8], width: u32, height: u32) -> Result<Self, ImageError> {
...
mod tests {
    ...
    fn test_simple_image_data() {
        ...
        let image_data = SimpleImageData::new(&data, 2, 2);
        assert_eq!(
            image_data,
            Ok(SimpleImageData {
                data: &data,
        ...
        let image_data = SimpleImageData::new(&data, 3, 1);
